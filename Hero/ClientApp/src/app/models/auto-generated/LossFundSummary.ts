...
export class LossFundSummary {  
    public ledgerReference: string;
    public lossFundPolicyCurrencyIsoCode: string;
    public policyCurrencySymbol: string;
    ...
    public binderYearNo: number;
    public lossFundsAvailableInGbp: boolean;
    public policyCurrencyExchangeRateToGbp: number;
    public pendingPaymentRequestsExcludingTpaFees: Models.PaymentRequest[]; 
}
