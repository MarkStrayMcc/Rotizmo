...
@Injectable()
export class FinancialTransactionsFilterHandlerService {
    ...
    public onLedgerChanged(selectedLedger: FinancialLedgerLookup): void {
        this.binderLookupService.getData(selectedLedger)
            .subscribe(data => this.binderLookupsSubject.next(data));
    }
