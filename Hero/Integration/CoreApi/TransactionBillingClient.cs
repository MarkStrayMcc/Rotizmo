...
namespace Hero.Integration.CoreApi.TransactionBilling
{
    ...
    public partial interface ITransactionBillingClient
    {
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task PutAsync(string policyNumber, UpdateTransactionBillingRequest request);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task PutAsync(string policyNumber, UpdateTransactionBillingRequest request, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.16.0.0 (NJsonSchema v10.7.1.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class TransactionBillingClient : ITransactionBillingClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public TransactionBillingClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task PutAsync(string policyNumber, UpdateTransactionBillingRequest request)
        {
            return PutAsync(policyNumber, request, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task PutAsync(string policyNumber, UpdateTransactionBillingRequest request, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("/api/policy/{policyNumber}/transactions/billing");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ValidationException(objectResponse_.Text);
                        }
                        else
                        if (status_ == 500)
                        {
    ...
    public partial class UpdateTransactionBillingRequest
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.0.0 (NJsonSchema v10.7.1.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum UpdateTransactionBillingRequestType
    {
